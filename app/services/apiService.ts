...
export const autoGenerateNewProgram = async (
  ...
  console.log(
    "autoGenerateNewProgram: Received response status:",
    response.status
  );
...
export const updateUserActiveProgram = async (
  ...
  const updatePayload: UserPreferencesPayload = {
    ...currentPrefs, // Inclut toutes les préférences actuelles
    user_id: userId,
    active_program_id: activeProgramId,
  };
  console.log(
    "updateUserActiveProgram: Updating user",
    userId,
    "with payload:",
    updatePayload
  );
  ...
  console.log(
    "updateUserActiveProgram: Received response status:",
    response.status
  );
  return handleApiResponse<UserPreferencesDetail | { error: string }>(response);
};
