...
export const autoGenerateNewProgram = async (
  ...
  console.log("autoGenerateNewProgram: Received response status:", response.status);
  return handleApiResponse<AutoGeneratedProgramResponse>(response);
};
...
export const updateUserActiveProgram = async (
  ...
  const updatePayload = { active_program_id: activeProgramId };
  console.log("updateUserActiveProgram: Updating user", userId, "with payload:", updatePayload);
  ...
  console.log("updateUserActiveProgram: Received response status:", response.status);
  return handleApiResponse<UserPreferencesDetail | { error: string }>(response);
};
